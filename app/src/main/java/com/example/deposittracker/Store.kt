...
data class Entry(val date: String, val amount: Long, val source: String)
...
object Store {
    ...
    fun getEntries(context: Context): List<Entry> {
        ...
        for (i in 0 until arr.length()) {
            ...
            list.add(Entry(o.getString("date"), o.getLong("amount"), o.optString("source", "پیامک")))
        }
        return list
    }

    fun addEntry(context: Context, amount: Long, source: String) {
        val prefs = context.getSharedPreferences(PREFS, Context.MODE_PRIVATE)
